<template>
  <div>
    <div class="q-ma-lg">
      <h2 class="text-h5 text-weight-medium">Verification code</h2>
      <h6 class="text-subtitle2 text-weight-light q-mt-lg">
        Please verify your phone number by entering the code sent to your number
      </h6>
    </div>
    <div class="full-width">
      ...
      >
        ...
        <div class="flex justify-center">
          <router-link to="secure" style="text-decoration: none">
            <q-btn
              style="
